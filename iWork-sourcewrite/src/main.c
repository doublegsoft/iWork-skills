...
// Callback when entering a block element
...
// Callback when leaving a block element
...
// Callback when entering a span element
...
// Callback when leaving a span element
...
int main(int argc, char* argv[]) {
  struct arg_file* opt_input  = arg_file1("m", "markdown",  "<markdown file path>", "markdown input file");
  struct arg_str*  opt_output = arg_str0("o", "output", "<output directory>",  "output root directory (default: out)");
